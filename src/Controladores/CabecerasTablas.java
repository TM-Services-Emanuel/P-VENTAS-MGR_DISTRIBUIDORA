...
public final class CabecerasTablas {
    ...
    private static final String clientes[] = {"ID","COD INTERNO","NOMBRE FANTASÍA","NOMBRE Y APELLIDO | RAZÓN SOCIAL", "C.I. | R.U.C.", "DIRECCIÓN", "TELÉFONO", "CIUDAD"};
    ...
    String motivo[] = {"ID", "VENDEDOR","ci","direccion","telefono","USUARIO","CONTRASEÑA"};
    ...
    String puntoEmision[] = {"ID", "IDT", "TIMBRADO", "EST.", "P.E.", "DIRECCION", "INICIO", "FIN", "ACTUAL", "N°.VTA.", "TIPO", "TIPO2", "DIR. IP", "ESTADO"};
    ...
    //String detalleFactura[] = {"CANT","DEP","IDDEP", "ID","CÓD.INT","NOMBRE COMERCIAL", "PRECIO", "TOTAL","PROMO"};
    String detalleFactura[] = {"CANT", "DEP", "IDDEP", "ID", "CÓD.BARRA", "DESCRIPCIÓN", "PRECIO", "TOTAL", "PROMO", "IVA"};
    ...
    static String datosCV [][] = {};
    private static DefaultTableModel modelo;
    private static DefaultTableModel modeloCV;
    ...
    public static void limpiarTablasCV(JTable tabla) {
        tabla.setModel(modeloCV);
        int filas = tabla.getRowCount();
        for (int i = 0; i < filas; i++) {
            modeloCV.removeRow(0);
        }
    }

    public static void ContabilidadVenta(JTable tabla) {
        modeloCV = new DefaultTableModel(datosCV, CV){
    ...
    public void ajusteStock(JTable tabla) {
        modelo = new DefaultTableModel(datos, articulosMovil);
        tabla.setModel(modelo);
        colum = tabla.getColumnModel().getColumn(0);
        colum.setPreferredWidth(70);
        colum.setMaxWidth(0);
