...
import IU.dlgReporteVentapoCliente1;
import IU.dlgVentas;
...
public class controlFactura {
    ...
    public static void selectCliente1()//Seleccionar Cliente
    {
        ...
        dlgReporteVentapoCliente.lbNombreFantacia.setText("Nombre de Fantasía: "+cl.getNombre_fantacia());
    ...
    public static void listFacturasMovilContabilidad(JTable tabla, String desde, String hasta)//Lista las facturas realizadas
    {
        List lista;
        lista = GestionarFactura.listFacturasMovilContabilidad(desde, hasta);
        for (int i = 1; i < lista.size(); i++) {
            DefaultTableModel tb = (DefaultTableModel) tabla.getModel();
            Object[] fila = (Object[]) lista.get(i);
            String filaf[] = new String[19];
            filaf[0] = "1";
            filaf[1] = String.valueOf(fila[0].toString());
            String ruc = fila[1].toString();
            Object[] parts = ruc.split("-");
            filaf[2] = parts[0].toString();
            filaf[3] = fila[2].toString();
            filaf[4] = "101";
            filaf[5] = Fecha.formatoFechaDinver(fila[3].toString());
            filaf[6] = String.valueOf(fila[4].toString());
            filaf[7] = String.valueOf(fila[5].toString());
            filaf[8] = fila[6].toString();
            filaf[9] = fila[7].toString();
            filaf[10] = fila[8].toString();
            filaf[11] = String.valueOf(fila[9].toString());
            filaf[12] = String.valueOf(fila[10].toString());
            filaf[13] = "N";
            filaf[14] = "S";
            filaf[15] = "N";
            filaf[16] = "N";
