...
public class GestionarCliente {
    ...
    public static String actCliente(ClienteMovil c) {
        ...
        StringBuilder sql = new StringBuilder("UPDATE clientes SET nombre_fantacia='");
        sql.append(c.getNombre_fantacia()).append("', razon_social='");
        sql.append(c.getRazonSocial()).append("', ruc='");
        sql.append(c.getRuc()).append("',direccion='");
        sql.append(c.getDireccion()).append("', ref1='");
        sql.append(c.getRef1()).append("', ref2='");
        sql.append(c.getRef2()).append("', telefono='");
        sql.append(c.getTelefono()).append("',ciudad_idciUdad=");
        sql.append(c.getCodCiudad()).append(", cod_ident=");
        sql.append(c.getCodI()).append(" WHERE idcliente=");
        sql.append(c.getIdCliente()).append("");
...
//        String sql = "UPDATE clientes SET cli_indicador='N' WHERE cli_codigo = " + cod + "";
    ...
    public static ClienteMovil busCliente(String cod) {
        ...
        if (filaObt != null) {
            ...
            c.setCod_interno((filaObt[1].toString()));
            c.setNombre_fantacia((filaObt[2].toString()));
            c.setRazonSocial(filaObt[3].toString());
            c.setRuc(filaObt[4].toString());
            c.setDireccion(filaObt[5].toString());
            c.setRef1(filaObt[6].toString());
            c.setRef2(filaObt[7].toString());
            c.setTelefono(filaObt[8].toString());
            c.setCodCiudad(Integer.parseInt(filaObt[10].toString()));
            c.setCodI(Integer.parseInt(filaObt[11].toString()));
...
//        String sql = "SELECT * FROM clientes WHERE cli_ruc LIKE '" + cod + "%'";
    ...
    public static List listClientes(String cod) {
        ...
        sql.append("clientes.cod_interno,");
        sql.append("clientes.nombre_fantacia,");
    ...
    public static List filRazonS(String cad) {
        ...
        sql.append(" OR clientes.nombre_fantacia LIKE '%").append(cad).append("%'");
        sql.append(" OR clientes.cod_interno LIKE '").append(cad).append("'");
