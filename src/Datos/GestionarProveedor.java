...
//        String sql = "SELECT * FROM proveedor WHERE pro_codigo = " + cod + "";
    ...
    public static List listProveedor(String cod) {
        StringBuilder sql = new StringBuilder(" SELECT `p-ventasbd`.proveedor.pro_codigo, ");
        //sql.append("proveedor.ciudad_ciu_codigo, ");
        sql.append("`p-ventasbd`.proveedor.pro_razonsocial, ");
        sql.append("`p-ventasbd`.proveedor.pro_ruc, ");
        sql.append("`p-ventasbd`.proveedor.pro_telefono, ");
        sql.append("`p-ventasbd`.proveedor.pro_contacto, ");
        sql.append("`p-ventasbd`.proveedor.pro_celular, ");
        sql.append("`bd_distribuidoradani`.ciudad.ciudad, ");
        sql.append("`p-ventasbd`.proveedor.pro_direccion, ");
        sql.append("`p-ventasbd`.proveedor.pro_observacion ");
        sql.append("FROM `p-ventasbd`.proveedor ");
        sql.append("JOIN `bd_distribuidoradani`.ciudad ON `p-ventasbd`.proveedor.ciudad_ciu_codigo = `bd_distribuidoradani`.ciudad.idciudad ");
        sql.append("WHERE `p-ventasbd`.proveedor.pro_indicador = 'S' ");
