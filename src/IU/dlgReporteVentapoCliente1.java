...
public class dlgReporteVentapoCliente1 extends javax.swing.JDialog {
    ...
    public dlgReporteVentapoCliente1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        jasper = new Reporte();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgReporteVentapoCliente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgReporteVentapoCliente1 dialog = new dlgReporteVentapoCliente1(new javax.swing.JFrame(), true);
