...
public class dlgConsultarCompras1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbCompra.setSelectionBackground(new java.awt.Color(102, 102, 102));
        ...
        tbDetalleCompra.setSelectionBackground(new java.awt.Color(102, 102, 102));
        ...
        lbValorTotal.setBackground(new java.awt.Color(0, 102, 102));
        ...
        btnCargar.setBgHover(new java.awt.Color(1, 123, 123));
        btnCargar.setFocusPainted(false);
        btnCargar.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        btnCargar.setIconTextGap(0);
        btnCargar.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.ADD_SHOPPING_CART);
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (resp == JOptionPane.YES_OPTION) {
            if (tbCompra.getSelectedRow() < 0) {
                ...
                int TotalC = Integer.parseInt(dlgGestRepartos.txtValorCompra.getText()) + Integer.parseInt(lbValorTotal.getText().replace(".", "").replace(",", ""));
               // Mensajes.error(String.valueOf(TotalC));
                dlgGestRepartos.txtValorCompra.setText(String.valueOf(TotalC));
