...
import Controladores.controlUMMovil;
import Datos.GestionarUMMovil;
import java.awt.HeadlessException;
import javax.swing.JOptionPane;

public class dlgUMMovil extends javax.swing.JDialog {

    CabecerasTablas cabe = new CabecerasTablas();
    public dlgUMMovil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulo();
        cabe.UM(tbUM);
        controlUMMovil.listUnidadMedida(tbUM);
    }
    
    final void titulo(){
        if(Software.getSoftware().equals("null")){
            this.setTitle("Gestionar Unidad de medida");
        }else{
            this.setTitle(Software.getSoftware()+" - Gestionar Unidad de medida");
        }
    }
    ...
    private void initComponents() {
        ...
        txtunidad.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        txtequivalencia.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtunidad, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 13, Short.MAX_VALUE)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtequivalencia, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        tbUM.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 10)); // NOI18N
        ...
        tbUM.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tbUM.getTableHeader().setResizingAllowed(false);
        tbUM.getTableHeader().setReorderingAllowed(false);
        tbUM.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbUMMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbUM);
    ...
    private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirActionPerformed
        ...
        if (rpta == 0) {
            try{
                cargarComboBoxMovil.cargar(dlgGestArticulosMovil.cboUM, "SELECT * FROM unidad_medida WHERE estado='S'");
            }catch(Exception e){}
            this.dispose();
        }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        // TODO add your handling code here:
        String cod = GestionarUMMovil.getCodigo();
        txtCod.setText(cod);
        ...
        txtunidad.setText("");
        txtequivalencia.setEnabled(true);
        txtequivalencia.setText("");
        CabecerasTablas.limpiarTablas(tbUM);
        controlUMMovil.listUnidadMedida(tbUM);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try{
            ...
            if (resp == JOptionPane.YES_OPTION){
                controlUMMovil.delUnidadMedida();
                CabecerasTablas.limpiarTablas(tbUM);
                controlUMMovil.listUnidadMedida(tbUM);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try{
            ...
            if (resp == JOptionPane.YES_OPTION){
                controlUMMovil.actUnidadMedida();
                CabecerasTablas.limpiarTablas(tbUM);
                controlUMMovil.listUnidadMedida(tbUM);
                btnCancelarActionPerformed(null);
            }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        if (validarCampos.estaVacio(txtunidad) ) {
            try{
                int resp = JOptionPane.showConfirmDialog(this,"¿Seguro que desea insertar el registro?", "Insertar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                if (resp == JOptionPane.YES_OPTION){
                    String cod = GestionarUMMovil.getCodigo();
                    txtCod.setText(cod);
                    controlUMMovil.addUnidadMedida();
                    CabecerasTablas.limpiarTablas(tbUM);
                    controlUMMovil.listUnidadMedida(tbUM);
                    btnCancelarActionPerformed(null);
                }
            ...
            Mensajes.informacion("Debe llenar obligatoriamente los campos Unidad de medida y Equivalencia");
            txtunidad.requestFocus();
        }
        
    }//GEN-LAST:event_btnGuardarActionPerformed

    private void tbUMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbUMMouseClicked
        // TODO add your handling code here:
        btnNuevo.setEnabled(false);
        itemNuevo.setEnabled(false);
        ...
        int fila = tbUM.getSelectedRow();
        String cod = tbUM.getValueAt(fila, 0).toString();
        String nom = tbUM.getValueAt(fila, 1).toString();
        String cant = tbUM.getValueAt(fila, 2).toString();

        txtCod.setText(cod);
        txtunidad.setText(nom);
        txtequivalencia.setText(cant);
        txtunidad.requestFocus();
    }//GEN-LAST:event_tbUMMouseClicked
    ...
    private void txtequivalenciaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtequivalenciaKeyPressed
        // TODO add your handling code here:
        if (!txtequivalencia.getText().trim().isEmpty()) {
            validarCampos.soloNumeros(txtequivalencia);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgUMMovil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            dlgUMMovil dialog = new dlgUMMovil(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTextField txtequivalencia;
