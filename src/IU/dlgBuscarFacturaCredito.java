...
public class dlgBuscarFacturaCredito extends javax.swing.JDialog {
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        try {
            ...
            if (Seleccionados(8)) {
                int rpta = Mensajes.confirmar("¿Seguro que desea anexar las " + Integer.parseInt(txtCant.getText()) + " facturas seleccionadas?");
                if (rpta == 0) {
                    for (int i = 0; i < tbCompraCredito.getRowCount(); i++) {
                        boolean sel = (boolean) tbCompraCredito.getValueAt(i, 8);
                        if (sel) {
                            int codCompra = Integer.valueOf(String.valueOf(tbCompraCredito.getModel().getValueAt(i, 0)));
                            String factura = String.valueOf(tbCompraCredito.getModel().getValueAt(i, 4));
                            int monto_factura = Integer.valueOf(String.valueOf(tbCompraCredito.getModel().getValueAt(i, 5)));
                            int monto_pago = Integer.valueOf(String.valueOf(tbCompraCredito.getModel().getValueAt(i, 7)));
