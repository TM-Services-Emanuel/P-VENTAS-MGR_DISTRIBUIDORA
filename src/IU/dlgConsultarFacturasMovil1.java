...
public class dlgConsultarFacturasMovil1 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbVentasMoviles.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
        ...
        tbDetalleVentasMoviles.setFont(new java.awt.Font("Roboto", 0, 11)); // NOI18N
            ...
            if (estado.equals("ANULADO")) {
                ...
                try {
                    ...
                    if (rpta == 0) {
                        ...
                        int rpta2 = Mensajes.confirmar("Desea RE-IMPRIMIR el duplicado de la Factura Móvil");
                        if (rpta2 == 0) {
