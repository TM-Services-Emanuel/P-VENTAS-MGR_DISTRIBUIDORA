...
public class dlgBuscarCliente2 extends javax.swing.JDialog {

    public dlgBuscarCliente2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarCliente2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            dlgBuscarCliente2 dialog = new dlgBuscarCliente2(new javax.swing.JFrame(), true);
